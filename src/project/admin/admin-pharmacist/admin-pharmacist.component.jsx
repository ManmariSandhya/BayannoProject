...
import './admin-pharmacist.component.css';

import {  deletePharmacist, getPharmacist, savePharmacist} from '../../services/pharmacist.service';
import { AdminHeaderComponent } from '../adminheader/adminheader.component';
import { ArrowRightCircle } from 'react-bootstrap-icons';
import { GridComponent } from '../../../shared_component/grid_component/grid.component';

export function AdminPharmacistComponent() {
        ...
        <div>
            ...
            <form className="container Bayanno-form">
                ...
                {showPopup && (
                    <div className="popup">
                        <div className="popup-content">
                            ...
                            <form className='container' method='post' action='http://localhost:4001/savePharmacist/' >
                ...
                <GridComponent
                    ...
                    deleteRecord={(value)=>{deletePharmacistItem(value)} }
                ></GridComponent>
            </form>
